...
df = pd.read_csv(r"D:\PROJECT\Cropify\CROPIFY_ML-main\crop_recomendation.csv")
...
joblib.dump(rf, r"D:\PROJECT\Cropify\CROPIFY_ML-main\random_forest.pkl")
joblib.dump(mlp, r"D:\PROJECT\Cropify\CROPIFY_ML-main\MLP.pkl")
joblib.dump(dt, r"D:\PROJECT\Cropify\CROPIFY_ML-main\random_tree.pkl")
joblib.dump(nb, r"D:\PROJECT\Cropify\CROPIFY_ML-main\naive_bayes.pkl")
